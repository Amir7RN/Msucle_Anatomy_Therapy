...
export interface JointMovement {
   ...
   *  to move. */
  howTo?:     string
  /** Per-movement neutral starting pose (from the tele-goniometry JSON the
   *  user supplied).  Spoken on camera-ready so the user sets up the right
   *  posture for THIS specific motion (e.g. shoulder rotation needs elbow
   *  at 90 degrees - generic "stand still" wouldn't cover it). */
  neutralPose?:        string
  /** How the user should orient themselves relative to the camera for this
   *  measurement (front-facing vs side-on, etc.).  Concatenated after
   *  neutralPose in the camera-ready cue. */
...
export const JOINT_MOVEMENTS: Record<string, JointMovement> = {
  shoulder_abduction:  {
    ...
    neutralPose:       'Stand upright facing the camera, feet evenly weighted, arms hanging at your sides with palms facing your thighs.',
    cameraOrientation: 'Face the camera directly so both shoulders and ears are visible.',
  ...
  shoulder_flexion: {
    ...
    neutralPose:       'Stand or sit upright with arms relaxed at your sides, palms facing your thighs. Your shoulder starts at zero degrees.',
    cameraOrientation: 'Stand sideways to the camera so your profile is in view, with the arm being measured closest to the lens.',
  ...
  shoulder_external_rotation: {
    ...
    neutralPose:       'Stand or sit upright with the arm being measured tucked at your side, elbow bent ninety degrees, forearm pointing forward, thumb up.',
    cameraOrientation: 'Face the camera. Keep your elbow pinned to your side and ninety degrees the entire time.',
  ...
  elbow_flexion: {
    ...
    neutralPose:       'Stand or sit upright with your arm alongside your body, elbow fully straight, palm facing forward.',
    cameraOrientation: 'Stand sideways to the camera with the arm being measured closest to the lens. Keep the upper arm aligned with your torso.',
  ...
  hip_flexion: {
    ...
    neutralPose:       'Stand upright with your pelvis level, feet hip-width apart, knees straight.',
    cameraOrientation: 'Stand sideways to the camera so your profile is in view. Use a wall for balance if needed.',
  ...
  hip_abduction: {
    ...
    neutralPose:       'Stand upright facing the camera with feet together, knees straight, pelvis level.',
    cameraOrientation: 'Face the camera directly. Use a wall for balance if needed.',
  ...
  knee_flexion: {
    ...
    neutralPose:       'Stand tall with the leg being measured fully straight.',
    cameraOrientation: 'Stand sideways to the camera with the knee being measured closest to the lens. Position the camera roughly thigh height, five to seven feet back.',
  ...
  cervical_rotation_left: {
    ...
    neutralPose:       'Sit or stand upright with your head and neck aligned neutrally, shoulders relaxed.',
    cameraOrientation: 'Face the camera with shoulders square to the lens, at eye level.',
  ...
  trunk_flexion: {
    ...
    neutralPose:       'Stand upright with feet shoulder-width apart, arms relaxed at your sides, spine in neutral curve.',
    cameraOrientation: 'Stand sideways to the camera so your profile is captured. Keep your knees straight and your head in line with your spine.',
  ...
  shoulder_extension: {
    ...
    neutralPose:       'Stand or sit upright with arms relaxed at your sides, palms facing your thighs.',
    cameraOrientation: 'Stand sideways to the camera so the arm being measured is closest to the lens.',
  ...
  shoulder_adduction: {
    ...
    neutralPose:       'Stand upright facing the camera, feet evenly weighted, arms hanging at your sides.',
    cameraOrientation: 'Face the camera directly so both shoulders are visible.',
  ...
  hip_extension: {
    ...
    neutralPose:       'Stand upright with your pelvis level, feet hip-width apart, knees straight.',
    cameraOrientation: 'Stand sideways to the camera. Use a wall for balance if needed.',
  ...
  hip_adduction: {
    ...
    neutralPose:       'Stand upright facing the camera with feet together, knees straight.',
    cameraOrientation: 'Face the camera directly.',
  ...
  hip_rotation: {
    ...
    neutralPose:       'Sit on a chair with your hip and knee both bent ninety degrees, foot off the ground, thigh pointing forward.',
    cameraOrientation: 'Face the camera so both knees are visible in the seated position.',
  ...
  ankle_dorsiflexion: {
    ...
    neutralPose:       'Stand or sit with your knee bent ninety degrees and your foot flat on the floor.',
    cameraOrientation: 'Place yourself sideways to the camera so your foot and ankle are in profile.',
  ...
  cervical_flexion: {
    ...
    neutralPose:       'Sit or stand upright with your head in neutral, earlobe stacked over your shoulder.',
    cameraOrientation: 'Turn sideways to the camera so your profile is captured. Keep your trunk still and shoulders relaxed.',
  ...
  cervical_lateral_flexion_left: {
    ...
    neutralPose:       'Sit or stand upright facing the camera, head and neck neutral, shoulders relaxed.',
    cameraOrientation: 'Face the camera directly with both ears visible. Keep your shoulders level - do not let them rise.',
  ...
  trunk_extension: {
    ...
    neutralPose:       'Stand upright with feet shoulder-width apart, arms relaxed at your sides, spine in neutral curve.',
    cameraOrientation: 'Stand sideways to the camera so your profile is captured. Keep your knees straight.',
  ...
  trunk_lateral_flexion_left: {
    ...
    neutralPose:       'Stand upright facing the camera with feet shoulder-width apart, arms at your sides.',
    cameraOrientation: 'Face the camera directly. Keep your pelvis level and avoid rotating the torso.',
  ...
  trunk_rotation_left: {
    ...
    neutralPose:       'Stand upright with feet shoulder-width apart. Cross your arms over your chest or place your hands on your shoulders to keep the arms still.',
    cameraOrientation: 'Face the camera directly so the amount of rotation is visible. Keep your pelvis stationary.',
